...
type LoginRequest struct {
	...
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Password      string                 `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`
	AppId         int32                  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` //id of the app, that user wants to login
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_service_service_proto_rawDesc = "" +
	"\n" +
	"\x15service/service.proto\x12\aservice\"C\n" +
	...
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin2\xbd\x01\n" +
	"\x04Auth\x12?\n" +
	"\bRegister\x12\x18.service.RegisterRequest\x1a\x19.service.RegisterResponse\x126\n" +
	"\x05Login\x12\x15.service.LoginRequest\x1a\x16.service.LoginResponse\x12<\n" +
	"\aIsAdmin\x12\x17.service.IsAdminRequest\x1a\x18.service.IsAdminResponseB\x1fZ\x1dperajush.service.v1;servicev1b\x06proto3"
...
var file_service_service_proto_goTypes = []any{
	...
	(*IsAdminRequest)(nil),   // 4: service.IsAdminRequest
	(*IsAdminResponse)(nil),  // 5: service.IsAdminResponse
}
var file_service_service_proto_depIdxs = []int32{
	0, // 0: service.Auth.Register:input_type -> service.RegisterRequest
	2, // 1: service.Auth.Login:input_type -> service.LoginRequest
	4, // 2: service.Auth.IsAdmin:input_type -> service.IsAdminRequest
	1, // 3: service.Auth.Register:output_type -> service.RegisterResponse
	3, // 4: service.Auth.Login:output_type -> service.LoginResponse
	5, // 5: service.Auth.IsAdmin:output_type -> service.IsAdminResponse
